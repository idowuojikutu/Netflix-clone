        ...
        //So it will set Parameters for Search Based API
            ...
            window.location.search.split("=")[0].split("?")[1].split("_").join(" ")
            );
            query = urlparam;
            ...
            API_Mapping[
            query
            ].Additional_Params = `&language=en-US&include_adult=false&query=${decodeURIComponent(
        ...
        populatecontainonpage(
            API_Mapping[query].API,
            Additional_Params,
            "sectionimages"
        );
        ...
        if (
            window.pageYOffset > mainsection.offsetHeight - 600 &&
            (showcasewindow.style.display === "" ||
